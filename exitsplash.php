...
theDiv = theDiv + '<div id="ExitCancelButtonImageDiv" style="background: #ffffff; width: 100%;" align="left"><img src="http://exitsplash.s3.amazonaws.com/files/exitimpactimage0.gif?exit586a2d4fd2fed" border="0"></div>';
